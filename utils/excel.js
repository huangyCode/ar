...
const excel_export = (obj) =>{
    ...
    obj.ctx.response.set('Content-Type', 'application/octet-stream');
    obj.ctx.response.set('Content-Disposition', 'attachment; filename=' + obj.fileName + '.xlsx');
    obj.ctx.body = filestream
